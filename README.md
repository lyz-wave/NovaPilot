...
- **Testing**: Vitest (511+ tests / 43 files) + Playwright (14 E2E acceptance scripts, `.xxx-check.cjs`)
...
### Verify
    ...
    npm test            # 511+ unit tests / 43 files
